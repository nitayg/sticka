      ...
      <div className="flex h-full items-center px-4 justify-between">
        ...
        <div className="flex items-center order-1">
          <div className="relative group">
            <div className="absolute -inset-1 rounded-full opacity-0 group-hover:opacity-100 bg-yellow-500/20 blur-lg transition-opacity duration-300"></div>
            <img 
        ...
        <div className="flex items-center space-x-1 rtl:space-x-reverse order-2">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="h-9 w-9 rounded-full hover:bg-yellow-500/10 hover:text-yellow-400 transition-all duration-300"
            onClick={toggleTheme}
          >
            {theme === 'dark' ? (
